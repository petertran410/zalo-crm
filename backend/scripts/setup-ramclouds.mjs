// Tạm: cấu hình custom provider Ramclouds cho 1 org. Chạy bằng node trong container (dist).
import { addCustomProvider, listCustomProviders, setProviderApiKey, setProviderBaseUrl } from '../dist/modules/ai/provider-registry.js';
import { updateAiConfig } from '../dist/modules/ai/ai-service.js';
