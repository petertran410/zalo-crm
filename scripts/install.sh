#!/usr/bin/env bash
#
# install.sh — Bootstrap 1 LỆNH cho Hi-CRM.
#
...
#
# Đặt repo nguồn qua biến môi trường ZCRM_REPO trước khi chạy:
#   ZCRM_REPO=<git-url> bash install.sh
...
# ── Luồng chính ─────────────────────────────────────────────────────────────────
echo "═══════════════════════════════════════════════"
echo "  Hi-CRM — Cài đặt / Cập nhật TỰ ĐỘNG (1 lệnh)"
echo "═══════════════════════════════════════════════"
...
echo "→ Hướng dẫn sử dụng: https://docs.your-domain.com/"
