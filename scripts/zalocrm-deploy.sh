#!/usr/bin/env bash
#
# zalocrm-deploy.sh — Cài đặt / Nâng cấp Hi-CRM TỰ ĐỘNG.
#
...
[ -f docker-compose.yml ] || die "Không thấy docker-compose.yml — chạy ở thư mục gốc mã nguồn Hi-CRM."
...
if [ "$MODE" = "install" ]; then
  ...
  echo "═══ NÂNG CẤP Hi-CRM (giữ dữ liệu) ═══"
