...
Các thay đổi đáng chú ý của Hi-CRM. Theo [Semantic Versioning](https://semver.org/lang/vi/).

> `v3.4.x` là dòng release hiện tại.

## [3.4.0] - 2026-06-20

Đợt cập nhật lớn: **giao diện mới** + **Dashboard mới**, **nâng cao bảo mật**, **quét nhóm Zalo**, **bộ báo cáo mới**, **cầu Zalo ↔ Telegram**, **độ tin cậy chat**.
...
- **API hoàn chỉnh cho Hi-CRM Mobile App** — bộ REST API đầy đủ (auth, chat, contacts, lịch hẹn, báo cáo, push) phục vụ ứng dụng di động.
...
- Bộ nhận diện Hi-CRM mới (logo monochrome, design system) + user guide + quick start (quản trị/nhân viên).
