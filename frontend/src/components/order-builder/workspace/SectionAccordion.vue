...
function handleHeaderClick(sectionId: string) {
  ...
  // Only allow clicking on completed sections (edit mode)
  // For upcoming non-locked sections, must use "Tiếp theo" button
}
</script>
...
.ob-accordion__section--open {
  border-color: #0068FF;
  box-shadow: 0 4px 20px rgba(0, 104, 255, 0.08), 0 0 0 3px rgba(0, 104, 255, 0.06);
}
